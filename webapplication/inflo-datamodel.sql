...
ALTER TABLE Comments ADD votes int;

ALTER TABLE Notification ADD type VARCHAR(500) NOT NULL;
ALTER TABLE Notification drop foreign key Notification_ibfk_2;
ALTER TABLE Notification drop column userID;
ALTER TABLE Notification drop column status;
ALTER TABLE Notification ADD userIDReceiver int NOT NULL;
ALTER TABLE Notification ADD userIDSender int NOT NULL;
ALTER TABLE Notification ADD CONSTRAINT Notification_ibfk_2 FOREIGN KEY (userIDReceiver) REFERENCES auth_user(id);
ALTER TABLE Notification ADD CONSTRAINT Notification_ibfk_3 FOREIGN KEY (userIDSender) REFERENCES auth_user(id);
