    ...
    <path
       ...
       id="path821" />
            ...
            <div className="commentData">
                {/*<div className="commentRespond commentDataItem disabled" id="COMMENTRESPOND###"><h4>Respond</h4></div>*/}
                {/*<div class="commentEndorse commentDataItem" id="COMMENTENDORSE###"><button>Endorse</button></div>*/}
 

                <div className="commentAuthorContainer commentDataItem">
                <div className="commentImg"><img src={SignInImage} /></div>

               <div className="commentAuthorData">
                    <div className="commentAuthorName"><h2>by <span>{this.props.commentauthor}</span></h2>
                    </div>
       
                   <div className="commentAuthorDate"> <h4> on <span> {this.props.timestamp} </span></h4></div>
                </div>
              </div>
              </div>
